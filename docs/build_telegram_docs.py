...
story += msg_block(
    "3 · Повторное обращение (дубль не создан)",
    "пришла заявка, телефон или email которой уже есть в базе. Новый лид не создаётся — к старой карточке "
    "добавляется комментарий.",
    "номер существующего лида и источник новой заявки. Подробности — в комментариях карточки.",
    [
        L("🔁 Повторное обращение по лиду #1247 (источник website)."),
        L("Не создан дубль — добавлен комментарий."),
    ], "16:42")
